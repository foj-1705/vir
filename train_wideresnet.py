...
parser = argparse.ArgumentParser(description='Vulnerability-aware Reweighting')
...
parser.add_argument('--beta', default=5.0,
                    help='weight before kl (regularization-term)')
parser.add_argument('--seed', type=int, default=981, metavar='S',
                    help='random seed (default: 981)')
...
#parser.add_argument('--wei_type', default='exp')
...
def main():
    ...
    print("natural", natural_acc)
    print("robust", robust_acc)
